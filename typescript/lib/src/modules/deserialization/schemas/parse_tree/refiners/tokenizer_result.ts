...
//schemas
import type * as s_choice from "../../parse_tree_deserialization/schema.js"
import type * as s_function from "../../parse_tree_deserialization/schema.js"
import type * as s_in from "../../token/schema.js"
...
export const Value: declarations.Value = (iterator, abort) => ({
...
export const Text: declarations.Text = (iterator, abort, $p) => {
    return iterator.consume(
...
export const Items: declarations.Items = (iterator, abort, $p) => iterator.build_list({
...
export const ID_Value_Pairs: declarations.ID_Value_Pairs = (iterator, abort, $p) => iterator.build_list({
...
export const Document: declarations.Document = ($, abort) => p_iterate<
    s_out.Document,
